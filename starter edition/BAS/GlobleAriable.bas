...
Public Const cfgConfig_FileName = "WBAHSConfig.xml" '设置文件名
...
Public Const cfgWindow_FileName = "WBAHSWindow.xml"
...
Public Const UpdataURL = "http://www.mapaler.com/tools/checkver/index.php?soft=Win7BootAnimeHelperStarter&mod=xmlverinfo&ver=newest" '升级监测网址
